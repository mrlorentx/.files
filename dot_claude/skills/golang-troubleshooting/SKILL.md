...
- → See `skills/golang-safety` skill for safety pitfalls and defensive patterns
- → See `skills/golang-error-handling` skill for error wrapping and handling patterns
