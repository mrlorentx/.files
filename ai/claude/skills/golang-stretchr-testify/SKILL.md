...
Use `testifylint` to catch wrong argument order, assert/require misuse, and more. See `skills/golang-linter` skill.

## Cross-References

- → See `skills/golang-testing` skill for general test patterns, table-driven tests, and CI
- → See `skills/golang-linter` skill for testifylint configuration
